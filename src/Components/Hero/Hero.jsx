      ...
      <Container>
        <div className="flex flex-col items-start md:flex-row md:items-center md:gap-16">
          <div className="flex flex-col">
            <h1 className="text-h3 leading-tight md:text-[48px] lg:text-[80px] text-white capitalize font-work font-regular tracking-tighter md:leading-[1.1] mb-6 font-medium">
