...
const Auction = () => {
  return (
    <Container className="relative h-screen md:h-[80vh] bg-auction bg-cover bg-no-repeat bg-center flex md:items-end">
      <div className="absolute top-0 left-0 w-full h-screen md:h-[80vh] from-cta to-transparent bg-gradient-to-t z-0"></div>
      <div className="flex flex-col md:flex-row w-full justify-center gap-12 md:items-end md:justify-between z-10">
        <div className="flex flex-col items-start gap-6">
          ...
          <Button
            filled={true}
            className="bg-white opacity-100 hidden md:flex md:w-[200px]"
          >
            <img src="./Icons/Eye.svg" alt="Eye icon" className="w-6 h-6" />
            <p className="text-bg">See NFT</p>
          </Button>
        </div>
        ...
        <Button filled={true} className="bg-white opacity-100 flex md:hidden">
          <img src="./Icons/Eye.svg" alt="Eye icon" className="w-6 h-6" />
          <p className="text-bg">See NFT</p>
        </Button>
      </div>
